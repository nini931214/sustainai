      ...
      <div className="w-full max-w-2xl rounded-3xl border bg-white p-10 shadow-lg">
        ...
        <div className="mb-8 grid grid-cols-2 gap-4">
          ...
          {[
            ...
            <div
              key={item}
              className="rounded-2xl border p-4 text-gray-700"
            >
              ✓ {item}
            </div>
          ))}
        ...
        <button
          ...
          className="w-full rounded-2xl bg-black px-6 py-4 font-semibold text-white transition hover:bg-gray-800"
        >
          閱讀服務條款
        </button>
